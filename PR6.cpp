...
int main() {
    ...
    cout << "Номер второго аккаунта: " << secondAccount.getAccountNumber() << "\n" << endl;

    cout << "Процентная ставка для первого аккаунта: " << firstAccount.getInterest() << endl;
    cout << "Процентная ставка для второго аккаунта: " << secondAccount.getInterest() << "\n" << endl;

    cout << "Баланс первого аккаунта: " << firstAccount.getBalance() << endl;
    cout << "Баланс второго аккаунта: " << secondAccount.getBalance() << "\n" << endl;

    if (transfer(firstAccount, secondAccount, 500.0)) {
        cout << "Перевод на 500 рублей выполнен!" << endl;
        cout << "Баланс первого аккаунта после перевода: " << firstAccount.getBalance() << endl;
        cout << "Баланс второго аккаунта после перевода: " << secondAccount.getBalance() << "\n" << endl;
    }
    else
    ...
    cout << "Баланс второго аккаунта после внесения: " << secondAccount.getBalance() << "\n" << endl;
    ...
    cout << "Баланс второго аккаунта после снятия: " << secondAccount.getBalance() << "\n" << endl;
